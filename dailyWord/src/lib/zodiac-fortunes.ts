export interface ZodiacFortune {
  ...
  love: string;
  money: string;
  health: string;  overallScore: number; // 1-5
  loveScore: number;
  moneyScore: number;
  healthScore: number;
}
...
const MONKEY_FORTUNES: ZodiacFortune[] = [
  {
    ...
    health: "가벼운 스트레칭이나 산책으로 몸을 풀어주면 컨디션이 좋아집니다. 수분 섭취를 충분히 하세요.",    overallScore: 4,
    loveScore: 5,
    moneyScore: 3,
    healthScore: 4,
  },
  {
    ...
    health: "충분한 수면이 오늘의 건강 포인트입니다. 일찍 잠자리에 드는 것을 추천합니다.",    overallScore: 3,
    loveScore: 4,
    moneyScore: 3,
    healthScore: 3,
  },
  {
    ...
    health: "에너지가 넘치지만 과로는 금물! 적당한 휴식과 활동의 밸런스를 유지하세요.",    overallScore: 5,
    loveScore: 4,
    moneyScore: 4,
    healthScore: 3,
  },
  {
    ...
    health: "스트레스가 쌓이지 않도록 가벼운 운동을 해주세요. 요가나 명상이 특히 좋습니다.",    overallScore: 4,
    loveScore: 5,
    moneyScore: 4,
    healthScore: 3,
  },
  {
    ...
    health: "눈의 피로에 주의하세요. 디지털 기기 사용 시간을 조절하고 틈틈이 먼 곳을 바라보세요.",    overallScore: 4,
    loveScore: 3,
    moneyScore: 4,
    healthScore: 4,
  },
  {
    ...
    health: "야외 활동이 몸과 마음에 활력을 줍니다. 점심시간에 잠깐이라도 밖에 나가보세요.",    overallScore: 4,
    loveScore: 4,
    moneyScore: 3,
    healthScore: 5,
  },
  {
    ...
    health: "규칙적인 식사가 건강의 기본! 균형 잡힌 영양 섭취에 신경 쓰세요.",    overallScore: 3,
    loveScore: 5,
    moneyScore: 4,
    healthScore: 4,
  },
  {
    ...
    health: "어깨와 목 근육에 신경 쓰세요. 자세 교정과 마사지가 도움이 됩니다.",    overallScore: 5,
    loveScore: 4,
    moneyScore: 5,
    healthScore: 3,
  },
  {
    ...
    health: "두뇌 활동이 활발한 만큼 충분한 수분과 견과류 섭취가 좋습니다.",    overallScore: 4,
    loveScore: 3,
    moneyScore: 3,
    healthScore: 4,
  },
  {
    ...
    health: "명상이나 호흡 운동이 심신 안정에 도움이 됩니다. 잠들기 전 5분간 시도해보세요.",    overallScore: 5,
    loveScore: 4,
    moneyScore: 4,
    healthScore: 5,
  },
  {
    ...
    health: "소화 기능이 민감해질 수 있으니 자극적인 음식은 피하고 따뜻한 차를 마셔보세요.",    overallScore: 3,
    loveScore: 4,
    moneyScore: 3,
    healthScore: 3,
  },
  {
    ...
    health: "음주나 과식에 주의하세요. 즐거운 자리에서도 절제가 필요합니다.",    overallScore: 4,
    loveScore: 5,
    moneyScore: 4,
    healthScore: 2,
  },
  {
    ...
    health: "체력 관리에 신경 쓰세요. 규칙적인 운동 습관이 건강을 지켜줍니다.",    overallScore: 3,
    loveScore: 3,
    moneyScore: 3,
    healthScore: 4,
  },
  {
    ...
    health: "전반적으로 컨디션이 좋은 날이에요. 이 기회에 좀 더 강도 높은 운동을 해보세요.",    overallScore: 5,
    loveScore: 5,
    moneyScore: 5,
    healthScore: 5,
  },
  {
    ...
    health: "마음의 건강도 중요합니다. 좋아하는 음악을 듣거나 일기를 써보세요.",    overallScore: 3,
    loveScore: 3,
    moneyScore: 3,
    healthScore: 4,
  },
  {
    ...
    health: "친구와 함께하는 운동이 효과 만점! 러닝 메이트를 구해보세요.",    overallScore: 4,
    loveScore: 4,
    moneyScore: 4,
    healthScore: 4,
  },
  {
    ...
    health: "목과 기관지 관리에 신경 쓰세요. 따뜻한 물을 자주 마시는 것이 좋습니다.",    overallScore: 4,
    loveScore: 5,
    moneyScore: 4,
    healthScore: 3,
  },
  {
    ...
    health: "디톡스가 필요한 날. 가벼운 식단과 충분한 물 섭취로 몸을 정화해보세요.",    overallScore: 3,
    loveScore: 3,
    moneyScore: 3,
    healthScore: 5,
  },
  {
    ...
    health: "새로운 스포츠를 시작해보기 좋은 날. 클라이밍이나 수영 같은 활동을 추천합니다.",    overallScore: 5,
    loveScore: 4,
    moneyScore: 4,
    healthScore: 4,
  },
  {
    ...
    health: "감정 기복이 있을 수 있으니 충분한 휴식을 취하세요. 아로마 테라피가 도움이 됩니다.",    overallScore: 3,
    loveScore: 5,
    moneyScore: 2,
    healthScore: 3,
  },
  {
    ...
    health: "활동적인 에너지를 잘 활용하세요. 러닝이나 사이클링이 특히 좋습니다.",    overallScore: 4,
    loveScore: 4,
    moneyScore: 4,
    healthScore: 5,
  },
